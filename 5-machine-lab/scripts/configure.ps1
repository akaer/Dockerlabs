...
$FilesToRun = @( Get-ChildItem -Path "C:\OEM\*.ps1" -Exclude configure.ps1,env.ps1,user-profile.ps1,cluster_setup.ps1,cluster_test.ps1 -ErrorAction SilentlyContinue )
